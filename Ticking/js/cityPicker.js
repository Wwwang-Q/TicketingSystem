...
IIInsomniaCityPicker.prototype = {
    ...
    targetEvent: function(f){ 
        ...
        that.settings.target.click(function(event){
           ...
           // var txt="<div class='be' style='right: 30px;'></div>"+that.template.html()+"<div class='af' style='right: 30px;'></div>";
            //var txt1="<div class='be' style='left: 20px;'></div>"+that.template.html()+"<div class='af' style='left: 20px;'></div>";           
        //that.template.html(txt);
            var offset = _this.offset();  
            var top = offset.top + _this.outerHeight() + 15;
            var right=$(window).width()-offset.left-_this.width();
            var ttop1=top-17;
            var ttop2=top-20;
...
//          var tright=$(that.template).css('right'); 
//           tright=tright.split('px');
//           tright=parseInt(tright);
//           tright+=30;   //上面费了半天劲为了得到right，微笑脸
             var tright=right+30;
          
                 var be=$("<div class='be' style='right:"+tright+"px;top:"+ttop1+"px;'></div>"); 
                 var af=$("<div class='af' style='right:"+tright+"px;top:"+ttop2+"px;'></div>"); 
             ...
             var tleft=offset.left+30;
          
                 var be=$("<div class='be' style='left:"+tleft+"px;top:"+ttop1+"px;'></div>"); 
                 var af=$("<div class='af' style='left:"+tleft+"px;top:"+ttop2+"px;'></div>"); 
            
            }
            
            $('body').append(that.template);       
            $(that.template).before(be);
            $(that.template).after(af);
